  ...
  return (
    <header>
      <div className="border-b">
        <div className="max-width bg-white flex py-5 w-full justify-between items-center ">
          <div
          ...
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:block">
              <Link to="#" className="text-[#333] text-[15px]">
                Login <span className="text-[12px] font-thin">/</span> Registar
              </Link>
            </div>
            <div className="flex gap-4">
              ...
              <div className="relative">
                ...
                <span className="absolute -top-2 -right-2.5 size-5 flex justify-center items-center rounded-full bg-red-500 text-white text-[10px]">
                  0
                </span>
              </div>
      ...
      <div className="flex justify-between py-4 max-width">
        <nav>
          <ul
            className={
              isOpen
